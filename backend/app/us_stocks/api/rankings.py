...
from app.us_stocks.core.config import MAX_WINDOW, MIN_WINDOW
from app.us_stocks.services.ranking_service import (
    RankingConfig,
    available_dates,
    build_ranking,
)
...
router = APIRouter(prefix="/api/us-stocks/rankings", tags=["us-stocks-rankings"])
